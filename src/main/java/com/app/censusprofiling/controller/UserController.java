...
public class UserController {
	...
	ResponseEntity<User> getEmpByEmail(@PathVariable("email") String email) throws LoginNotFoundException {
	...
	public Optional<User> getUserByApplicationId(@PathVariable int id) throws ApplicationNotFoundException{
		return iUserService.findByApplicationId(id);
	}
	
	@GetMapping("/user/applicationStatus/{status}")
	public List<User> getUserByApplicationStatus(@PathVariable String status) throws ApplicationNotFoundException{
